...
const ZasilkovnaWrapper = ({
			...
			try {
				window.Packeta.Widget.pick(
					...
					(point: ZasilkovnaPoint | null) => {
						if (point) {
							const event = new CustomEvent("onZasilkovnaPointSelect", {
								detail: point,
							});
	...
	useEffect(() => {
		document.addEventListener(
			"onZasilkovnaPointSelect",
			onPointSelect as EventListener,
		);
...
export const ZasilkovnaWidget = dynamic(
	() => Promise.resolve(ZasilkovnaWrapper),
	{
		ssr: false,
	},
);
