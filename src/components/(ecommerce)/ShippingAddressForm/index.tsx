						...
						<FormControl>
							...
							>
								<FormControl>
									<SelectTrigger
										id="country-select"
										className="w-full appearance-none rounded-md bg-white py-2 pr-3 text-base text-gray-900 outline-solid outline-1 -outline-offset-1 outline-gray-300 focus:outline-solid focus:outline-2 focus:-outline-offset-2 focus:outline-main-600 focus:ring-0 focus:ring-offset-0 sm:text-sm/6"
									>
					...
					<FormItem className="sm:col-span-2">
						...
						<FormControl>
							<Input
								...
								id="phone"
								type="tel"
								autoComplete="tel tel-international tel-country-code"
								{...field}
								onChange={(e) => {
									field.onChange(e);
								}}
