				...
				<Container style={container}>
							...
							<Row>
								<Column>
									...
									<Text style={track.number}>
										{order.orderDetails.shipping === "zasilkovna-box"
											? `Z${order.orderDetails.trackingNumber}`
								...
								<Column align="right">
									<Link
										...
										href={
											order.orderDetails.shipping === "zasilkovna-box"
												? `https://tracking.packeta.com/${locale}/?id=${order.orderDetails.trackingNumber}`
												: undefined
										}
									>
										{t("tracking-number")}
					...
					<Section style={message}>
						...
						<Text style={global.text}>
							{t(`${order.orderDetails.status}.subtitle`, {
								orderID: order.id,
							})}
						</Text>
					...
					<Section style={global.defaultPadding}>
						<Text style={adressTitle}>
							{order.orderDetails.shipping === "zasilkovna-box"
								? `${t("shipping-zbox")} `
								: `${t("shipping-house")} ${order.shippingAddress.name}`}
						</Text>
					...
					<Section style={global.defaultPadding}>
						<Row style={{ display: "inline-flex", marginBottom: 40 }}>
							...
							<Column>
								...
								<Text style={track.number}>
									{formatDateTime(order.createdAt, "EU")}
								</Text>
							</Column>
						</Row>
						<Row>
							<Column align="center">
								<Link
									href={`${baseUrl}/${locale}/order/${order.id}?x=${order.orderDetails.orderSecret}`}
									style={global.button}
								>
									{t("order-status")}
								</Link>
              ...
              <Column style={{ ...recomendations.product, paddingRight: "4px" }} align="center">
                ...
                <Text style={recomendations.text}>Women's Nike Pre-Match Football Top</Text>
					...
					<Section style={paddingY}>
						...
						<Row>
							<Text style={{ ...footer.text, paddingTop: 3, paddingBottom: 0 }}>
								{t("copyright")}
							</Text>
						</Row>
						<Row>
							<Text style={{ ...footer.text, paddingTop: 0, paddingBottom: 0 }}>
								{t("company-address")}
							</Text>
						</Row>
					</Section>
