					...
					fields: [
						...
						},
						{
							...
							admin: {
								components: {
									RowLabel:
										"@/components/(ecommerce)/RowLabels/OrderProductsRowLabel#OrderProductsRowLabel",
								},
							},
							fields: [
								{
								...
								},
								{
									...
									admin: {
										...
										components: {
											Field:
												"@/collections/(ecommerce)/Orders/components/ProductNameField#ProductNameField",
										},
									},
								},
								{
									...
									fields: [
										...
										},
										{
											...
											admin: {
												components: {
													Field:
														"@/collections/(ecommerce)/Orders/components/VariantSelect#VariantSelect",
												},
												width: "50%",
											},
										},
									...
									admin: {
										condition: (data) =>
											Boolean(
												...
												["inpost-pickup", "zasilkovna-box"].includes(
													data.orderDetails?.shipping,
												),
											),
										components: {
											Field:
									...
									fields: [
										{
											...
											admin: {
												...
												condition: (data) =>
													data.orderDetails.shipping === "inpost-pickup" ||
													data.orderDetails.shipping === "zasilkovna-box",
											},
										},
										{
										...
										{
											name: "pickupPointBranchCode",
											type: "text",
											label: {
												en: "Pickup point Branch Code",
												cs: "URL výdejního místa",
											},
											admin: {
												width: "25%",
												readOnly: true,
