...
export const Products: CollectionConfig = {
	...
	fields: [
		...
		...slugField(),
		{
			...
			admin: {
				position: "sidebar",
				description: "Zadejte EAN kód nebo vlastní kód.",
			},
		},
		{
			type: "tabs",
					...
					fields: [
						...
						},
						{
							...
							admin: {
								components: {
									RowLabel:
										"@/collections/(ecommerce)/Products/components/RowLabels/DetailLabel#DetailLabel",
								},
							},
							fields: [
								{
					...
					fields: [
						...
						},
						{
							...
							admin: {
								components: {
									RowLabel:
										"@/collections/(ecommerce)/Products/components/RowLabels/OptionLabel#OptionLabel",
								},
								condition: (_, siblingData) =>
									Boolean(
										siblingData.enableVariants &&
											siblingData.variantsType !== "sizes",
									),
								initCollapsed: true,
							},
							fields: [
						...
						},
						{
							...
							admin: {
								...
								condition: (_, siblingData) =>
									Boolean(
										siblingData.enableVariants &&
											siblingData.variantsType !== "colors",
									),
								initCollapsed: true,
							},
							fields: [
						...
						},
						{
							...
							validate: (value) => {
								...
								const groupedByVariantSlug = value.reduce(
									...
									fields: [
										{
											...
											admin: {
												components: {
													Field:
														"@/collections/(ecommerce)/Products/components/SizeSelect#SizeSelect",
												},
												condition: (_, siblingData) =>
													siblingData.variantsType !== "colors",
											},
										},
										{
											...
											admin: {
												components: {
													Field:
														"@/collections/(ecommerce)/Products/components/ColorSelect#ColorSelect",
												},
												condition: (_, siblingData) =>
													siblingData.variantsType !== "sizes",
											},
