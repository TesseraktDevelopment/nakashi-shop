...
export const WithImageGalleryExpandableDetails = ({
	...
	const filledVariants: FilledVariant[] | undefined = product.variants?.map(
		(variant) => ({
			...
			<div className="container mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
				<div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
					...
					<div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
							...
							<>
								<div className="mt-3">
									...
									<div className="flex items-center">
										...
										<p className="sr-only">
											{/* {product.rating} - temporary disabled*/}5 z 5
											hvězdiček
										</p>
									</div>
								</div>
						...
						<section aria-labelledby="details-product-code" className="mt-4">
							<span className="text-gray-600 text-xs">
								{product.code ? `Kód produktu: ${product.code}` : ""}
							</span>
						</section>
