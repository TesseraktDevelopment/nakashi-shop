			...
			fields: [
				{
					...
					options: [
						{
							label: { cs: "Z dané kategorie", en: "From category" },
							value: "category",
						},
						{
							label: { cs: "Z dané podkategorie", en: "From subcategory" },
							value: "subcategory",
						},
						{
							label: {
								cs: "Ručně vybrané produkty",
								en: "Manual picked products",
							},
							value: "manual",
						},
					],
				...
				},
				{
					...
					options: [
						...
						{
							label: { cs: "Se sliderem", en: "With slider" },
							value: "slider",
						},
						{
							label: {
								cs: "Se smyčkovým sliderem",
								en: "With infinite slider",
							},
							value: "sliderLoop",
						},
					],
